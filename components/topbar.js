...
export default function TopBar({iconName , textContent}){
    ...
    return (
        ...
        <View style={{ width:"100%" , display:"flex" , flexDirection:'row',padding:10 , paddingLeft:20, paddingRight:20 , backgroundColor:'#e6ecf2' , height:70}}>
            
            {/* this should be a drawer */ }
            <TouchableOpacity style={{elevation:5,marginRight:10 , borderRadius:15 , paddingLeft:10 , paddingRight:10 , alignItems:'center' ,display:'flex' , flexDirection:'row',elevated:2 , backgroundColor:'white' , width:"80%"}}>
